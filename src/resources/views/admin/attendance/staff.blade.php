...
<div class="attendance-list-container">
  ...
  <div class="month-switch">
    <a href="{{ route('admin.attendance.staff', ['user'  => $user->id,'month' => $prevMonth]) }}">← 前日</a>
  ...
  <div class="button-area">
    <a href="{{ route('admin.staff.attendance.csv', ['user' => $user->id,'month' => $currentMonth->format('Y-m')]) }}" class="btn-csv">
      CSV出力
    </a>
  </div>
